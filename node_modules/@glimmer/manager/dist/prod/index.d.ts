import { ComponentManager, ModifierManager, HelperManager, Owner, InternalHelperManager, HelperDefinitionState, Helper, HelperManagerWithDestroyable, HelperManagerWithValue, HelperCapabilitiesVersions, HelperCapabilities, InternalComponentManager, InternalModifierManager, ComponentCapabilitiesVersions, ComponentCapabilities, Arguments, ComponentDefinitionState, VMArguments, Nullable, Destroyable, InternalComponentCapabilities, UpdatableTag, SimpleElement, CapturedArguments, ModifierCapabilitiesVersions, ModifierCapabilities, TemplateFactory, Expand, CapabilityMask, InternalComponentCapability, DynamicLayoutCapability, WithDynamicLayout, DynamicTagCapability, PrepareArgsCapability, WithPrepareArgs, CreateArgsCapability, AttributeHookCapability, ElementHookCapability, DynamicScopeCapability, CreateCallerCapability, UpdateHookCapability, WithUpdateHook, CreateInstanceCapability, WithCreateInstance, WrappedCapability, WillDestroyCapability, HasSubOwnerCapability, WithSubOwner } from '@glimmer/interfaces';
import { Reference } from '@glimmer/reference';
import { Tag } from '@glimmer/validator';
import { InternalComponentCapabilities as InternalComponentCapabilities$1 } from '@glimmer/vm';
...
type CapabilityOptions = Expand<{
    [P in keyof Omit<typeof InternalComponentCapabilities$1, 'Empty'>]?: boolean | undefined;
}>;
/**
