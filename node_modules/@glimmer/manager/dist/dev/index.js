...
}, FROM_CAPABILITIES = DEBUG ? new WeakSet : void 0;
...
function getInternalModifierManager(definition, isOptional) {
    DEBUG && debugAssert(// eslint-disable-next-line @typescript-eslint/no-unnecessary-condition -- JS-only check
    "object" == typeof definition && null !== definition || "function" == typeof definition, (() => // eslint-disable-next-line @typescript-eslint/no-base-to-string -- @fixme
...
function getInternalHelperManager(definition, isOptional) {
    debugAssert(// eslint-disable-next-line @typescript-eslint/no-unnecessary-condition -- JS-only check
    "object" == typeof definition && null !== definition || "function" == typeof definition, (() => // eslint-disable-next-line @typescript-eslint/no-base-to-string -- @fixme
