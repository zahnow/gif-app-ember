...
import { CONSTANT_TAG, INITIAL, validateTag, track, valueForTag, consumeTag, createTag, dirtyTag } from "@glimmer/validator";

const REFERENCE = Symbol("REFERENCE");

class ReferenceImpl {
    constructor(type) {
        this.tag = null, this.lastRevision = INITIAL, this.children = null, this.compute = null, 
        this.update = null, this[REFERENCE] = type;
    }
}
