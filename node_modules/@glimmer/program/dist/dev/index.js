 ...
 */
const DEFAULT_TEMPLATE_BLOCK = [ [ [ SexpOpcodes.Yield, 1, null ] ], [ "&default" ], [] ], DEFAULT_TEMPLATE = {
    // random uuid
    ...
    scope: null,
    isStrictMode: !0
}, WELL_KNOWN_EMPTY_ARRAY = Object.freeze([]), STARTER_CONSTANTS = [ !1, !0, null, void 0, WELL_KNOWN_EMPTY_ARRAY ], WELL_KNOWN_EMPTY_ARRAY_POSITION = STARTER_CONSTANTS.indexOf(WELL_KNOWN_EMPTY_ARRAY);
...
class ConstantsImpl {
    ...
    component(definitionState, owner, isOptional, debugName) {
        ...
        if (void 0 === definition) {
            ...
            }, definition.handle = this.value(definition), debugName && (definition.debugName = debugName), 
            this.componentDefinitionCache.set(definitionState, definition), this.componentDefinitionCount++;
        }
        return definition;
    }
    ...
    constructor() {
        ...
        this.helperDefinitionCount = 0, this.modifierDefinitionCount = 0, this.componentDefinitionCount = 0, 
        this.values = STARTER_CONSTANTS.slice(), this.indexMap = new Map(this.values.map(((value, index) => [ value, index ]))), 
        this.helperDefinitionCache = new WeakMap, this.modifierDefinitionCache = new WeakMap, 
...
class ProgramHeapImpl {
    constructor() {
        this.offset = 0, this.handle = 0, this.heap = new Int32Array(1048576), this.handleTable = [], 
        this.handleState = [];
    }
    entries() {
        return this.offset;
