 ...
 */
let scheduleDestroy, scheduleDestroyed, toIterator, toBool, getProp, setProp, getPath, setPath, warnIfStyleNotTrusted, assert, deprecate, scheduleRevalidate = () => {};
 ...
 */ function debugAssert(test, msg, options) {
    ...
    DEBUG && assert && assert(test, "string" == typeof msg ? msg : msg(), options);
}

/**
 * Hook to customize deprecation messages in the VM. Usages can be stripped out
 * by using the @glimmer/vm-babel-plugins package.
 */ let assertGlobalContextWasSet, testOverrideGlobalContext, globalContextWasSet = !1;
