 ...
 */
declare let scheduleRevalidate: () => void;
/**
 ...
 */
declare let scheduleDestroy: <T extends Destroyable>(destroyable: T, destructor: Destructor<T>) => void;
/**
 * Finalizes destruction
 *
 * @param finalizer finalizer function
 */
declare let scheduleDestroyed: (finalizer: () => void) => void;
/**
 * Hook to provide iterators for `{{each}}` loops
 *
 * @param value The value to create an iterator for
 */
declare let toIterator: (value: unknown) => IteratorDelegate | null;
/**
 * Hook to specify truthiness within Glimmer templates
 *
 * @param value The value to convert to a boolean
 */
declare let toBool: (value: unknown) => boolean;
/**
 ...
 */
declare let getProp: (obj: object, path: string) => unknown;
/**
 ...
 */
declare let setProp: (obj: object, prop: string, value: unknown) => void;
/**
 ...
 * @param path The path to get the value from
 */
declare let getPath: (obj: object, path: string) => unknown;
/**
 ...
 * @param path The path to get the value from
 */
declare let setPath: (obj: object, path: string, value: unknown) => unknown;
/**
 * Hook to warn if a style binding string or value was not marked as trusted
 * (e.g. HTMLSafe)
 */
declare let warnIfStyleNotTrusted: (value: unknown) => void;
/**
 * Hook to customize assertion messages in the VM. Usages can be stripped out
 * by using the @glimmer/vm-babel-plugins package.
 */
declare let assert: (test: unknown, msg: string, options?: {
    id: string;
}) => asserts test;
declare function debugAssert(test: unknown, msg: string | (() => string), options?: {
    id: string;
}): asserts test;
/**
 ...
 * by using the @glimmer/vm-babel-plugins package.
 */
declare let deprecate: (msg: string, test: unknown, options: {
    id: string;
}) => void;
...
declare function setGlobalContext(context: GlobalContext): void;
declare let assertGlobalContextWasSet: (() => void) | undefined;
declare let testOverrideGlobalContext: ((context: Partial<GlobalContext> | null) => GlobalContext | null) | undefined;

export { type Destroyable, type Destructor, type GlobalContext, assert, assertGlobalContextWasSet, debugAssert, setGlobalContext as default, deprecate, getPath, getProp, scheduleDestroy, scheduleDestroyed, scheduleRevalidate, setPath, setProp, testOverrideGlobalContext, toBool, toIterator, warnIfStyleNotTrusted };
